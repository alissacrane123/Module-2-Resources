...
1. Require the Friendly Dragon class from the `./problem-02-make-friendly-dragons.js` 
module.

2. Require the Evil Dragon class from the `./problem-03-make-evil-dragons.js` 
module.

3. Create 2 new instances, 1 of the Friendly Dragon Class and 
the other of the Evil Dragon Class with the following details:
    a. A Friendly Dragon named "Falkor" with the color "white", the life goals of
    "save Atreyu from the swamp", "save Atryu from the Nothing", and "scare 
    the local bullies into a dumpster" and has the friend "Bastian". Assign this 
    new instance to the variable `falkor`
    b. An Evil Dragon named "Smaug" with the color "black", the evilDoings of 
    "take over your mountain kingdom", "steal all your dwarven gold", and "burn down
    your floating village" and has the nemesis of "Dwarf King".  Assign this new instance
    to the variable named "smaug"

4. Call the static getDragons method on the Dragon Class with your `falkor` and `smaug` instances
   as arguements.  Save this method call to a variable named 'allDragons` and add it to 
   export statement that already exists.
